...
deploy:
	docker compose -f docker-compose.production.yml down && git pull && pnpm install && docker compose -f docker-compose.production.yml build --no-cache && docker compose -f docker-compose.production.yml up -d
postgres-backup:
