  ...
  const debts: DebtWithExpense[] = [
    {
      ...
      expense: {
        amount: new Decimal(52.61),
        payerId: "v719af4i38197yxwk6mutklx",
      },
    },
    {
      ...
      expense: {
        ...
        payerId: "mwj4i43lw4gh4j34vslgo2bq",
      },
    },
    {
...
test("advanced generateBalances", () => {
  const debts: DebtWithExpense[] = [
    ...
    },
    {
      ...
      debtorId: "clk5a4wfc002bmt5s8rxume8k",
      expense: {
        amount: new Decimal(126.26),
        payerId: "geya1lji1o2ol56zb27vy0bm",
      },
    },
    {
    ...
    {
      amount: new Decimal(74.069_999_999_999_99),
      settled: new Decimal(0),
      debtorId: "geya1lji1o2ol56zb27vy0bm",
      expense: {
        amount: new Decimal(1111),
        payerId: "ttivc09jodsj566qo11wwbyz",
      },
    },
    {
