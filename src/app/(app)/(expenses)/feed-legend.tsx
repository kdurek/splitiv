    ...
    <div className="rounded-md border p-4">
      <div className="grid grid-cols-3">
        <div className="text-center">
          <div className="mx-auto grid h-10 w-10 place-content-center rounded-md bg-blue-100">
        ...
        <div className="text-center">
          <div className="mx-auto grid h-10 w-10 place-content-center rounded-md bg-yellow-100">
        ...
        <div className="text-center">
          <div className="mx-auto grid h-10 w-10 place-content-center rounded-md bg-teal-100">
