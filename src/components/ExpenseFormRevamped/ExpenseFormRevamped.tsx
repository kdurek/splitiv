...
import ExpenseFormRevampedMethods from "./ExpenseFormRevampedMethods";
import { ExpenseFormSchemaRevamped } from "./ExpenseFormSchemaRevamped";

import type { ExpenseFormValuesRevamped } from "./ExpenseFormSchemaRevamped";

function ExpenseFormRevamped() {
...
export default ExpenseFormRevamped;
