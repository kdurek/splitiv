    ...
    <div className="border p-4 rounded-md">
      <div className="grid grid-cols-3">
        <div className="text-center">
          <div className="w-10 h-10 mx-auto bg-blue-100 grid place-content-center rounded-md">
        ...
        <div className="text-center">
          <div className="w-10 h-10 mx-auto bg-yellow-100 grid place-content-center rounded-md">
        ...
        <div className="text-center">
          <div className="w-10 h-10 mx-auto bg-teal-100 grid place-content-center rounded-md">
