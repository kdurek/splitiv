...
function atomWithDebounce<T>(initialValue: T, delayMilliseconds = 500, shouldDebounceOnReset = false) {
...
export const {
  isDebouncingAtom: isDebouncingSearchTextAtom,
  debouncedValueAtom: debouncedValueSearchTextAtom,
  clearTimeoutAtom: clearTimeoutSearchTextAtom,
  currentValueAtom: currentValueSearchTextAtom,
} = atomWithDebounce('');
